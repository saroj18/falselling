...
const Pricing = () => {
  ...
  const [selectedMaterial, setSelectedMaterial] = useState("gypsum");
  ...
  const materialPricing = [
    {
      ...
      installation: 35,
      total: 120,
      features: ["Lightweight", "Easy Installation", "Smooth Finish"],
    },
    {
      type: "PVC Panels",
      pricePerSqFt: 65,
      installation: 25,
      total: 90,
      features: ["Waterproof", "Low Maintenance", "Variety of Colors"],
    },
    {
      type: "Metal Ceilings",
      pricePerSqFt: 150,
      installation: 50,
      total: 200,
      features: ["Durable", "Fire Resistant", "Modern Look"],
    },
    {
      type: "Acoustic Ceilings",
      pricePerSqFt: 120,
      installation: 40,
      total: 160,
      features: [
    ...
    {
      type: "Wooden Ceilings",
      pricePerSqFt: 200,
      installation: 60,
      total: 260,
      features: ["Premium Quality", "Natural Look", "Long Lasting"],
    },
  ];
  ...
  const calculateTotal = () => {
    const material = materialPricing.find((m) =>
      m.type.toLowerCase().includes(selectedMaterial)
    );
    if (!material) return 0;
    return material.total * selectedArea;
  };
                  ...
                  <TableBody>
                    {materialPricing.map((item, index) => (
                      <TableRow key={index}>
                        ...
                        <TableCell>Rs. {item.pricePerSqFt}</TableCell>
